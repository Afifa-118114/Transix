  ...
  return (
    <div className="flex flex-col h-full bg-slate-900 border-r border-slate-800 text-slate-200">
      ...
      <div className="p-6 border-b border-slate-800/80">
        <Link to="/operator/dashboard" className="flex items-center gap-2 text-white">
      ...
      <div className="flex-1 px-4 py-6 space-y-6 overflow-y-auto custom-scrollbar">
        ...
        <div>
          ...
          <div className="space-y-1 text-xs font-bold">
            ...
            >
              <FiActivity className={pathname === "/operator/dashboard" ? "text-indigo-400" : ""} />
              <span>Overview</span>
            </Link>
          </div>
        </div>
          ...
          <div className="space-y-1 text-xs font-bold">
            ...
            >
              <span className="flex items-center gap-3">
                <FiCompass className={isPersonal ? "text-indigo-400" : ""} />
            ...
            >
              <span className="flex items-center gap-3">
                <GraduationCap size={15} className={isCampus ? "text-indigo-400" : ""} />
        ...
        <div>
          ...
          <div className="space-y-1 text-xs font-bold">
            <Link
              to="/vendor/requests"
              className={`flex items-center justify-between px-3 py-2 rounded-lg transition ${
                pathname === "/vendor/requests"
                  ? "text-white bg-indigo-600/20 border border-indigo-500/30 font-black"
                  : "text-slate-400 hover:text-white hover:bg-slate-800/50"
              }`}
            >
              <span className="flex items-center gap-3">
                <FiShield className={pathname === "/vendor/requests" ? "text-indigo-400" : "text-amber-400"} />
        ...
        <div>
          ...
          <div className="space-y-1 text-xs font-bold">
            <Link
              ...
              className={`flex items-center justify-between px-3 py-2 rounded-lg transition ${
                pathname === "/operator/bookings" || isAllTrips
                  ? "text-white bg-indigo-600/20 border border-indigo-500/30 font-black"
                  : "text-slate-400 hover:text-white hover:bg-slate-800/50"
              }`}
            >
              <span className="flex items-center gap-3">
                <FiCheckCircle className={pathname === "/operator/bookings" || isAllTrips ? "text-indigo-400" : ""} />
                <span>Bookings</span>
              </span>
              {pendingCount > 0 && (
            ...
            <Link
              ...
              className={`flex items-center justify-between px-3 py-2 rounded-lg transition ${
                pathname === "/operator/activities"
                  ? "text-white bg-indigo-600/20 border border-indigo-500/30 font-black"
                  : "text-slate-400 hover:text-white hover:bg-slate-800/50"
              }`}
            >
              <span className="flex items-center gap-3">
                <FiActivity className={pathname === "/operator/activities" ? "text-indigo-400" : ""} />
        ...
        <div>
          ...
          <div className="space-y-1 text-xs font-bold">
            <Link
              ...
              className={`flex items-center justify-between px-3 py-2 rounded-lg transition ${
                pathname === "/operator/vendor-requests"
                  ? "text-white bg-indigo-600/20 border border-indigo-500/30 font-black"
                  : "text-slate-400 hover:text-white hover:bg-slate-800/50"
              }`}
            >
              <span className="flex items-center gap-3">
                <FiBriefcase className={pathname === "/operator/vendor-requests" ? "text-indigo-400" : ""} />
            ...
            >
              <span className="flex items-center gap-3">
                <FiMessageSquare className={pathname === "/operator/chat" ? "text-indigo-400" : ""} />
                <span>Chat</span>
              </span>
            </Link>
          </div>
