...
export default function PlaceCard({ place }) {
  return (
    <div className="flex flex-col justify-between overflow-hidden rounded-2xl border border-slate-200/80 dark:border-slate-800/80 bg-white dark:bg-[#131b2e] shadow-xs transition-all duration-200 hover:-translate-y-0.5 hover:border-indigo-300 dark:hover:border-indigo-600/50 hover:shadow-md">
      {/* Image & Rating */}
      <div>
        ...
        <div className="p-3.5">
          ...
          <p className="mt-1 flex items-start gap-1 text-xs text-slate-500 dark:text-slate-400 line-clamp-2">
      ...
      <div className="p-3.5 pt-0">
        <div className="flex flex-col gap-2 border-t border-slate-100 dark:border-slate-800 pt-3">
          <button
            ...
            className="w-full rounded-xl bg-indigo-50 dark:bg-indigo-950/40 py-2 text-center text-xs font-bold text-indigo-700 dark:text-indigo-300 transition hover:bg-indigo-600 hover:text-white dark:hover:bg-indigo-600 dark:hover:text-white"
          >
            + Add to Tour
          </button>
          ...
          <div className="flex gap-2">
            {place.website && (
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="flex flex-1 items-center justify-center gap-1 rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 py-1.5 text-xs font-semibold text-slate-700 dark:text-slate-200 transition hover:bg-slate-50 dark:hover:bg-slate-700"
              >
                <FaGlobe size={11} />
                <span>Web</span>
              </a>
