    ...
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-50">
        <div className="flex flex-col items-center gap-3 rounded-2xl border border-slate-200 bg-white p-8 shadow-sm">
          ...
          <h2 className="text-base font-bold text-slate-800">Searching verified train routes...</h2>
          <p className="text-xs text-slate-500">Querying Indian Railways Kaggle dataset</p>
        </div>
      </div>
    );
  }
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-3.5">
        ...
        <div className="flex flex-wrap items-center justify-between gap-2.5 border-b border-slate-200/80 pb-3">
          <div className="flex items-center gap-2.5">
            <button
              onClick={() => navigate(-1)}
              className="flex items-center gap-1.5 rounded-xl border border-slate-200 bg-white px-3 py-1.5 text-xs font-bold text-slate-700 shadow-2xs transition hover:bg-slate-50 hover:text-indigo-600"
            >
            ...
            <div className="flex items-center gap-2">
              ...
              <div>
                <h1 className="text-sm sm:text-base font-extrabold text-slate-900 leading-tight">Travel Options</h1>
                <p className="text-[10px] text-slate-500">Official Indian Railways Verified Dataset</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex items-center gap-2 rounded-xl border border-slate-200 bg-white px-3.5 py-1.5 shadow-2xs">
            ...
            <span className="ml-1 rounded-md bg-indigo-50 px-1.5 py-0.5 text-[10px] font-bold text-indigo-700">
